...
module.exports = (passport) => {
    ...
    app.get('/nimportequoi',
        ...
        function (req, res) {
            // On affiche l'id de l'utilisateur qui a effectué la requête
            // (et qui est stocké dans la session de l'utilisateur losqu'il est authentifié)
            console.log('API : user is ', req.session.passport.user);
